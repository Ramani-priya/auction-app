class AutoBidService
  ...
  def determine_final_price(current_price, min_increment, highest_autobid, second_highest_autobid)
    if second_highest_autobid
      [second_highest_autobid.max_bid_price + min_increment, highest_autobid.max_bid_price].min
    else
