  ...
  def perform(auction_id)
    ...
    ActiveRecord::Base.transaction do
      ...
      final_price = if second_highest
                      [second_highest.max_bid_price + auction.minimum_increment,
                       current_eligible_autobid.max_bid_price].min
                    else
                      [(triggering_bid&.current_bid_price&.+ auction.minimum_increment),
                       current_eligible_autobid.max_bid_price].min
                    end
